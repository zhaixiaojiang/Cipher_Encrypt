...
public enum Des3Enum {
	...
	private Des3Enum(String encryptType) {
	...
	public static Des3Enum getMode(String encryptionMode){
		Des3Enum[] values = Des3Enum.values();
		for (Des3Enum value : values) {
			if (value.getEncryptType().equalsIgnoreCase(encryptionMode)) {
				return value;
			}
		}
		return Des3Enum.ECB_PKCS5PADDING;
	}
}
