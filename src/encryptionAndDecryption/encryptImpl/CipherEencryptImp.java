package encryptionAndDecryption.encryptImpl;





import encryptionAndDecryption.encryptTypeImpl.HexUtil;
 ...
 * 使用Cipher进行加密
 */
public abstract class CipherEencryptImp<E extends Enum<?>, T extends Enum<?>> implements ICipherEncrypt<E, T> {
	/**
	 * 若加密失败, 抛出该异常信息
	 */
	...
	protected abstract byte[] encrypt(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
	/**
	 * 解密
	 * @param content   : 解密内容
	 * @param slatKey   : 解密的盐
	...
	protected abstract String decrypt(byte[] content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
	...
	@Override
	public String encryptBase64(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception {
		byte[] result = encrypt(content, slatKey, vectorKey, encryptType, encryptKey);
		return Base64.getEncoder().encodeToString(result);
	}
	@Override
	public String decryptBase64(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception {
		byte[] byteContent = Base64.getDecoder().decode(content);
		return decrypt(byteContent, slatKey, vectorKey, encryptType, encryptKey);
	}
	@Override
	...
	@Override
	public String encryptHex(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception {
		byte[] result = encrypt(content, slatKey, vectorKey, encryptType, encryptKey);
		return HexUtil.byteArrayToHexStr(result);
	}
	@Override
	public String decryptHex(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception {
		byte[] byteContent = HexUtil.hexStrToByteArray(content);
		return decrypt(byteContent, slatKey, vectorKey, encryptType, encryptKey);
	}
}
