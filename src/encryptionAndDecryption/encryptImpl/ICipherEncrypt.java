 ...
 * Cipher类的加密、解密接口
 */
public interface ICipherEncrypt<E extends Enum<?>, T extends Enum<?>> {
	...
	String encryptBase64(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
	String decryptBase64(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
	...
	String encryptHex(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
	String decryptHex(String content, String slatKey, String vectorKey, E encryptType, T encryptKey) throws Exception;
}
